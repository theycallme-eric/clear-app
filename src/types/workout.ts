...
export const generateTestWorkout = (): GeneratedWorkout => {
  ...
  return {
    ...
    sections: [
      ...
      // 8. Carries For Time — for_time (5 min cap)
      {
        id: "sec-carries",
        name: "Carries For Time",
        type: "carries",
        status: "not_started",
        exercises: [
          {
            ...
            sets: null,
            reps: "40m",
            lastWeight: "70lbs each",
            equipment: "Dumbbells",
            coachingCues: ["Shoulders packed, core braced", "Short quick steps"],
          ...
          },
          {
            ...
            lastWeight: "50lbs",
            equipment: "Kettlebells",
            coachingCues: ["Stay vertical, don't lean away"],
            structure: { type: "for_time", time_cap_mins: 5 },
          },
        ],
      },
      // 9. Stability Ladder — standard with ladder rep strings
      {
        id: "sec-stability",
        name: "Stability Ladder",
        type: "stability",
        status: "not_started",
        exercises: [
          {
